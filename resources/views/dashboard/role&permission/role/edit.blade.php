                    ...
                    <form action="{{ route('roles.update', $role->id) }}" method="post">
                        ...
                        <div class="container">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" value=" {{ old('name', $role->name) }} " name="name" id="name" placeholder="Nombre">
                            </div>
                            <div class="form-group">
                                <label for=""></label>
                            ...
                            <div class="form-group">
                                <label for=""></label>
                                <textarea name="description" id="description" cols="100%" rows="10" placeholder="Description">{{ old('description' , $role->description) }} </textarea>
                            </div>
