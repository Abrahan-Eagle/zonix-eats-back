...
return [
    ...
    */
    ...
    'custom' => [
        'ci_number' => [
            'unique' => 'El número de cédula ya ha sido registrado. Por favor, verifique los datos ingresados.',
        ],
        'user_id' => [
        ...
        'profile_id' => [
            'exists' => 'El perfil seleccionado no es válido.',
        ],
    ],
